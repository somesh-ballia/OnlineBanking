...
<body>
    ...
    <div>
        ...
        <asp:Menu ID="Menu2" runat="server" BackColor="Purple" DynamicHorizontalOffset="2"
            Font-Bold="True" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#000040" Height="41px"
            OnMenuItemClick="Menu2_MenuItemClick" StaticSubMenuIndent="10px" Style="left: 796px;
        ...
        <asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4"
            ...
            ForeColor="#333333" OnAuthenticate="Login1_Authenticate" Style="left: 494px;
            position: absolute; top: 447px" Width="279px">
