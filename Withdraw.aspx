<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Withdraw.aspx.cs" Inherits="Statement" %>
                        ...
                        <tr style="font-weight: bold; color: #000000; text-decoration: underline">
                            ...
                            <td style="width: 303px; height: 647px" valign="top" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td colspan="2">
                                <asp:Label ID="Label4" runat="server" Font-Size="X-Large" Text="Withdraw Slip" Width="209px"></asp:Label></td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:Label ID="Label5" runat="server" CssClass="engtxt" ForeColor="#0000C0" Style="position: relative"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                <asp:Button ID="btndeposit" runat="server" Text="Withdraw" Width="72px" OnClick="btndeposit_Click" />
